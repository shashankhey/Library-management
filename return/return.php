      ...
      <div class="d-flex flex-column">
        ...
        <nav id="navbar" class="nav-menu navbar">
          <ul>
            ...
            <li><a href="#search" class="nav-link scrollto"><i class="bx bx-envelope"></i> <span>Search</span></a></li>
...
<tr>
    <th>Return Date</th>
    <td><input type="date" name="date" placeholder="Return Date" required></td>
</tr>
<tr>
    <th>Fine</th>
    <td><input type="rupees" name="fine" placeholder="Fine" required></td>
</tr>
<tr>
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql= "INSERT INTO `return`(`bookid`, `sid`, `returndate`, `fine`) VALUES ('$bid','$sid','$date','$fine')";
