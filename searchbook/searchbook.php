...
<body>
    ...
    <section id="welcome" class="d-flex flex-column justify-content-center align-items-center">
      <div class="welcome-container ">
        ...
        <form class="usn" action="searchbook.php" method="post">
    <tr>
        <th>Enter BID:-</th>   
            <td><input type="text" name="bookid" placeholder="Book ID" required="required"/> </td>
    ...
    if(isset($_POST['submit'])){
        ...
        {   
            ...
            <tr id="data" align="center" cellspacing="2" border="2" style="color: white; margin:2px;">
                <td style="padding: 5px;"><?php echo $data['bookid'] ?></td>
                <td style="padding: 5px;"><?php echo $data['bookname']; ?></td>
                <td style="padding: 5px;"><?php echo $data['subject']; ?></td>
                <td style="padding: 5px;"><?php echo $data['location']; ?></td>
            </tr>
