...
<tr>
    <th>Book ID</th>
    <td><input type="text" name="id" placeholder="Book ID" required></td>
</tr>
<tr>
    <th>Name</th>
    <td><input type="text" name="name" placeholder="Book name" required></td>
</tr>
<tr>
    <th>Subject</th>
...
<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $sql= "INSERT INTO `book`(`bookid`, `bookname`, `subject`, `location`) VALUES ('$bid','$name','$subject','$location')";
